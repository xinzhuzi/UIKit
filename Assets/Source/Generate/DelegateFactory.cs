...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Func<int,string>), factory.System_Func_int_string);
		dict.Add(typeof(System.Action<int,UnityEngine.UI.UITableCell>), factory.System_Action_int_UnityEngine_UI_UITableCell);
		...
		DelegateTraits<System.Func<int,string>>.Init(factory.System_Func_int_string);
		DelegateTraits<System.Action<int,UnityEngine.UI.UITableCell>>.Init(factory.System_Action_int_UnityEngine_UI_UITableCell);
		...
		TypeTraits<System.Func<int,string>>.Init(factory.Check_System_Func_int_string);
		TypeTraits<System.Action<int,UnityEngine.UI.UITableCell>>.Init(factory.Check_System_Action_int_UnityEngine_UI_UITableCell);
		...
		StackTraits<System.Func<int,string>>.Push = factory.Push_System_Func_int_string;
		StackTraits<System.Action<int,UnityEngine.UI.UITableCell>>.Push = factory.Push_System_Action_int_UnityEngine_UI_UITableCell;
	}
	...
	class System_Func_int_string_Event : LuaDelegate
	{
		public System_Func_int_string_Event(LuaFunction func) : base(func) { }
		public System_Func_int_string_Event(LuaFunction func, LuaTable self) : base(func, self) { }
	...
	public System.Func<int,string> System_Func_int_string(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Func<int,string> fn = delegate(int param0) { return null; };
			return fn;
		}

		if(!flag)
		{
			System_Func_int_string_Event target = new System_Func_int_string_Event(func);
			System.Func<int,string> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Func_int_string_Event target = new System_Func_int_string_Event(func, self);
			System.Func<int,string> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Func_int_string(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Func<int,string>), L, pos);
	}

	void Push_System_Func_int_string(IntPtr L, System.Func<int,string> o)
	{
		ToLua.Push(L, o);
	}

	class System_Action_int_UnityEngine_UI_UITableCell_Event : LuaDelegate
	{
		public System_Action_int_UnityEngine_UI_UITableCell_Event(LuaFunction func) : base(func) { }
		public System_Action_int_UnityEngine_UI_UITableCell_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(int param0, UnityEngine.UI.UITableCell param1)
		{
			func.BeginPCall();
			func.Push(param0);
			func.Push(param1);
		...
		public void CallWithSelf(int param0, UnityEngine.UI.UITableCell param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.Push(param0);
	...
	public System.Action<int,UnityEngine.UI.UITableCell> System_Action_int_UnityEngine_UI_UITableCell(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<int,UnityEngine.UI.UITableCell> fn = delegate(int param0, UnityEngine.UI.UITableCell param1) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_int_UnityEngine_UI_UITableCell_Event target = new System_Action_int_UnityEngine_UI_UITableCell_Event(func);
			System.Action<int,UnityEngine.UI.UITableCell> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_int_UnityEngine_UI_UITableCell_Event target = new System_Action_int_UnityEngine_UI_UITableCell_Event(func, self);
			System.Action<int,UnityEngine.UI.UITableCell> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_int_UnityEngine_UI_UITableCell(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<int,UnityEngine.UI.UITableCell>), L, pos);
	}

	void Push_System_Action_int_UnityEngine_UI_UITableCell(IntPtr L, System.Action<int,UnityEngine.UI.UITableCell> o)
	{
		ToLua.Push(L, o);
	}
