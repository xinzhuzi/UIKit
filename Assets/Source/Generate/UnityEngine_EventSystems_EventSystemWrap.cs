...
public class UnityEngine_EventSystems_EventSystemWrap
{
	...
	static int get_current(IntPtr L)
	{
		try
		{
			ToLua.PushSealed(L, UnityEngine.EventSystems.EventSystem.current);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_current(IntPtr L)
	{
		try
		{
			UnityEngine.EventSystems.EventSystem arg0 = (UnityEngine.EventSystems.EventSystem)ToLua.CheckObject(L, 2, typeof(UnityEngine.EventSystems.EventSystem));
