...
{
    [CustomEditor(typeof(UIParticleEffect))]
    [CanEditMultipleObjects]
    internal class UIParticleEffectEditor : GraphicEditor
    {
        //################################
        ...
        protected override void OnEnable()
        {
            ...
            _ro.drawHeaderCallback += rect =>
            {
                ...
                {
                    foreach (UIParticleEffect t in targets)
                    {
                        t.RefreshParticles();
                    }
                }
        ...
        {
            var current = target as UIParticleEffect;
            ...
            using (var ccs = new EditorGUI.ChangeCheckScope())
            {
                ...
                if (ccs.changed)
                {
                    foreach (UIParticleEffect p in targets)
                    {
        ...
        private void DestroyUIParticle(UIParticleEffect p, bool ignoreCurrent = false)
        {
