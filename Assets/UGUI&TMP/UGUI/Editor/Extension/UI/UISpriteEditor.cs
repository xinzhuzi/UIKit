...
namespace UnityEditor.UI
{
    ...
    /// </summary>
    public class UISpriteEditor : GraphicEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (GUILayout.Button(_spriteAtlasPlaceholder))
            {
                ...
                SpriteAtlasWindow.OnSelectedSpriteAtlas = SetSpriteAtlas;
            }
        ...
        private void SetSpriteAtlas(SpriteAtlas spriteAtlas)
        {
            ...
            if ((target as UISprite).spriteAtlas == spriteAtlas) return;
        ...
        private void SetSprite(Sprite sprite)
        {
            ...
            if ((target as UISprite).spriteName == sprite?.name || (target as UISprite).sprite == sprite)
            {
                return;
            }
        ...
        {
            var uisprite = target as UISprite;
            EditorGUI.BeginChangeCheck();
            
            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.ObjectField("Sprite Atlas :", uisprite.spriteAtlas,typeof(SpriteAtlas),false);
            EditorGUILayout.EndHorizontal();

            EditorGUILayout.BeginHorizontal();
            EditorGUILayout.LabelField("Sprite Name : " ,uisprite.spriteName);
            EditorGUILayout.EndHorizontal();
