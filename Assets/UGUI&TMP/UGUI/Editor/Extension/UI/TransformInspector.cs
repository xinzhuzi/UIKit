...
{
	static public TransformInspectorEditor instance;
	...
	void OnEnable ()
	{
		...
		Transform o = (Transform)target;
		targetSp = o.GetComponent<SpriteRenderer>();
	}
	...
	{
		UGUIEditorTools.SetLabelWidth(15f);
...
#region Rotation is ugly as hell... since there is no native support for quaternion property drawing
	...
	void DrawRotation (bool isWidget)
	{
		GUILayout.BeginHorizontal();
		{
			...
			{
				UGUIEditorTools.RegisterUndo("Change Rotation", serializedObject.targetObjects);
	...
	public static bool ShowSpriteOutline = false;
	private SpriteRenderer targetSp;
#endregion
}
