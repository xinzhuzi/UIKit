...
namespace UnityEditor.UI
{
    ...
    public class ScrollViewEditor : Editor
    {
        ...
        {
            m_Image                 = serializedObject.FindProperty("m_BgScrollImage");
            m_RawImage              = serializedObject.FindProperty("m_BgScrollRawImage");
        ...
        private GUIContent m_ImageGUIContent = new GUIContent("外部滑动背景Image");
        private GUIContent m_RawImageGUIContent = new GUIContent("外部滑动背景RawImage");
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_Image,m_ImageGUIContent);
            EditorGUILayout.PropertyField(m_RawImage,m_RawImageGUIContent);
