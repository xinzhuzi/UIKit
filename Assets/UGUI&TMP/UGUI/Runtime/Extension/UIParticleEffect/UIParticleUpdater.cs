...
namespace UnityEngine.UI
{
    ...
    {
        static readonly List<UIParticleEffect> s_ActiveParticles = new List<UIParticleEffect>();
        static MaterialPropertyBlock s_Mpb;
        static ParticleSystem.Particle[] s_Particles = new ParticleSystem.Particle[2048];
        private static int frameCount = 0;


        public static void Register(UIParticleEffect particle)
        {
            if (!particle) return;
            s_ActiveParticles.Add(particle);
        }

        public static void Unregister(UIParticleEffect particle)
        {
            if (!particle) return;
        ...
        private static void Refresh(UIParticleEffect particle)
        {
        ...
        private static void ModifyScale(UIParticleEffect particle)
        {
        ...
        private static void BakeMesh(UIParticleEffect particle)
        {
