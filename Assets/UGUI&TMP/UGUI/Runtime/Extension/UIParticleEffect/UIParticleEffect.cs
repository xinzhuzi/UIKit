...
namespace UnityEngine.UI
{
    ...
    public class UIParticleEffect : MaskableGraphic
#if UNITY_EDITOR
...
#endif
    {
        ...
        public void RefreshParticles(GameObject root)
        {
            ...
            particles.RemoveAll(x => x.GetComponentInParent<UIParticleEffect>() != this);
        ...
        private static void ClearPreviousMaterials()
        {
