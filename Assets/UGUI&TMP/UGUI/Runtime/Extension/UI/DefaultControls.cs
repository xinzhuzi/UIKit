...
namespace UnityEngine.UI
{
    ...
    public static class DefaultControls
    {
        ...
        private const float  kWidth       = 200f;
        private const float  kThickHeight = 80f;
        ...
        {
            // GameObject root = CreateUIElementRoot("ScrollView", new Vector2(200, 200), typeof(Image), typeof(ScrollView));
            GameObject root = CreateUIElementRoot("ScrollView", new Vector2(600, 600), typeof(ScrollView));

            // GameObject viewport = CreateUIObject("Viewport", root, typeof(Image), typeof(Mask));
            GameObject viewport = CreateUIObject("Viewport", root, typeof(RectMask2D));
            GameObject content = CreateUIObject("Content", viewport, typeof(RectTransform));
            // Sub controls.
        ...
        public static GameObject CreateTableXView()
        {
            var root = CreateUIElementRoot("HorizontalTableView", new Vector2(600, 600), typeof(UITableXView),typeof(RectMask2D));
            var rectTransform = root.GetComponent<RectTransform>();
            
            var content = CreateUIObject("Content", root,typeof(HorizontalLayoutGroup),typeof(ContentSizeFitter));
            var contentRT = content.GetComponent<RectTransform>();
            contentRT.anchorMin = Vector2.zero;
            contentRT.anchorMax = new Vector2(0, 1);
            contentRT.pivot = new Vector2(0, 0.5f);
            contentRT.sizeDelta = new Vector2(600, 600);
            ...
            var tableView = root.GetComponent<UITableXView>();
            tableView.content = contentRT;
            tableView.viewport = rectTransform;
            tableView.horizontalScrollbar = null;
            tableView.verticalScrollbar = null;
            tableView.horizontal = true;
            tableView.vertical = false;
            
            tableView.horizontalScrollbarVisibility = ScrollRect.ScrollbarVisibility.Permanent;
            tableView.verticalScrollbarVisibility = ScrollRect.ScrollbarVisibility.Permanent;
            tableView.horizontalScrollbarSpacing = 0;
            tableView.verticalScrollbarSpacing = 0;
            
            //缓存池子与模板
            var cellPool = CellPoolAndTemplate(root);
            root.GetComponent<UITableXView>().CellTemplate =
                new[] {cellPool.transform.GetChild(0).GetComponent<UITableCell>()};
            return root;
        }
        
        public static GameObject CreateTableYView()
        {
            var root = CreateUIElementRoot("VerticalTableView", new Vector2(600, 600), typeof(UITableYView),typeof(RectMask2D));
            var rectTransform = root.GetComponent<RectTransform>();
            
            var content = CreateUIObject("Content", root,typeof(VerticalLayoutGroup),typeof(ContentSizeFitter));
            var contentRT = content.GetComponent<RectTransform>();
            ...
            var tableView = root.GetComponent<UITableYView>();
            tableView.content = contentRT;
            tableView.viewport = rectTransform;
            tableView.horizontalScrollbar = null;
            tableView.verticalScrollbar = null;
            ...
            //缓存池子与模板
            var cellPool = CellPoolAndTemplate(root);
            root.GetComponent<UITableYView>().CellTemplate =
                new[] {cellPool.transform.GetChild(0).GetComponent<UITableCell>()};
            
            return root;
        }

        public static GameObject CreateGridXView()
        {
            var root = CreateUIElementRoot("HorizontalGridView", new Vector2(600, 600), typeof(UITableXView),typeof(RectMask2D));
            var rectTransform = root.GetComponent<RectTransform>();
            
            var content = CreateUIObject("Content", root,typeof(GridLayoutGroup),typeof(ContentSizeFitter));
            var contentRT = content.GetComponent<RectTransform>();
            contentRT.anchorMin = Vector2.zero;
            contentRT.anchorMax = new Vector2(0, 1);
            contentRT.pivot = new Vector2(0, 0.5f);
        ...
        public static GameObject CreateGridYView()
        {
            var root = CreateUIElementRoot("VerticalGridView", new Vector2(600, 600), typeof(UITableYView),typeof(RectMask2D));
        ...
        private static GameObject CellPoolAndTemplate(GameObject root)
        {
            //缓存池子
            var UICellPool = CreateUIObject("UICellPool", root,typeof(UICellPool));
            
            var canvasGroup = UICellPool.GetComponent<CanvasGroup>();
            canvasGroup.alpha = 0;
            canvasGroup.interactable = false;
            canvasGroup.blocksRaycasts = false;
            canvasGroup.ignoreParentGroups = true;
            
            var rect = UICellPool.GetComponent<RectTransform>();
