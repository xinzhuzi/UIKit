...
namespace UnityEngine.UI
{
    ...
    {
        protected const int kNoEventMaskSet = 32;
        protected const int m_UILayer = 5;
        ...
        [SerializeField]
        [Tooltip("Awake中获取 UIRootManager.UICamera,无需手动赋值,除非有特殊需求")]
        ...
        protected override void Awake()
        {
            ...
            _eventCamera = GameObject.FindWithTag("UICamera").GetComponent<Camera>();
        }
        ...
        public override void Raycast(PointerEventData eventData, List<RaycastResult> resultAppendList)
        {
            ...
            // if (canvas == null)
            //     return;
            //当你的 UI对象的 layer 不是 UI 的情况下,无需进入检测
            if (this.gameObject.layer != m_UILayer) return;
            #endregion
        ...
        #region 优化排序数据,只添加最上层的 UI 事件响应组件
        ...
        private static void Raycast(Canvas canvas, Camera eventCamera, Vector2 pointerPosition, IList<Graphic> foundGraphics, List<Graphic> results)
        {
            ...
            for (int i = 0; i < totalCount; ++i)
            {
                ...
                if (graphic.canvasRenderer.cull || depth == -1) continue;
                ...
                if (graphic.Raycast(pointerPosition, eventCamera))
                {
                    ...
                    {
                        upIndex = depth;
                        upGraphic = graphic;//记录最上层的 UI 响应组件
                    }
                }
            }
