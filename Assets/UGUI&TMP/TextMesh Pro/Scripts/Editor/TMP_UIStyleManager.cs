...
namespace TMPro.EditorUtilities
{
    ...
    public static class TMP_UIStyleManager
    {
        ...
        static TMP_UIStyleManager()
        {
            ...
            sectionHeader = new GUIStyle(EditorStyles.label) { fixedHeight = 22, richText = true, border = new RectOffset(9, 9, 0, 0), overflow = new RectOffset(9, 0, 0, 4), padding = new RectOffset(0, 0, 4, 0) };
