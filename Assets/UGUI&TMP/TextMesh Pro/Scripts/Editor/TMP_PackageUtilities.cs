...
namespace TMPro
{
    ...
    internal class TMP_ProjectTextSpacingConversionTool : EditorWindow
    {
        ...
        {
            string VMF = "Visible Meta Files";
#if !UNITY_2019_4
            VMF = VersionControlSettings.mode;
#else
            VMF = EditorSettings.externalVersionControl;
#endif
            // Check Project Asset Serialization and Visible Meta Files mode.
            if (EditorSettings.serializationMode != SerializationMode.ForceText || VMF != "Visible Meta Files")
            {
                return false;
            }
